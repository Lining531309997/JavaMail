...
public class MailUtil {
    ...
    public static String account = "15261851370@163.com";
    public static String password = "Li221243221200";
	...
	public static void sendMail(String to, String code) {
        ...
        try {
			...
			// 3.3设置邮件的主题
			message.setSubject("来自平台的激活邮件");
			// 3.4设置邮件的正文
			message.setContent("<h1>来自平台的激活邮件，激活请点击以下链接：</h1><h3><a href='http://localhost:10080/Demo_JavaMail/active?code=" + code + "'>http://localhost:10080/Demo_JavaMail/active?code=" + code + "</h3>", "text/html;charset=UTF-8");
			// 4.发送邮件
