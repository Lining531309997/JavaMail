package com.localhost.JavaMail;
...
public class SendEmail2 {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("F:/Chrome下载/备用模板/jiaoben3928/yzm.gif")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("F:/Chrome下载/备用模板/jiaoben3928/说明.txt"));  // 读取本地文件
